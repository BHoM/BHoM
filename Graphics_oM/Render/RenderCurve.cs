...
{
    [Description("Render a curve with specified colour and thickness.")]
    public class RenderCurve : IRender
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/

        [Description("The curve to render.")]
        public virtual ICurve Curve { get; set; }

        [Description("The thickness of the curve. Should be a value greater or equal to 1.")]
        public virtual int Thickness { get; set; } = 1;
