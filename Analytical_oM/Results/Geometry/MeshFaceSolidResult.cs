...
{
    public class MeshFaceSolidResult : IMeshFaceResult, ICasedResult
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public virtual IAdapterId FaceIndex { get; set; }
        ...
        public virtual MeshResultLayer MeshResultLayer { get; set; }
        ...
        public virtual double LayerPosition { get; set; }
