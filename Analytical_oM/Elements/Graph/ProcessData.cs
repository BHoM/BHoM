...
{
    [Description("Defines input data and expected output data for one run of a particular process.")]
    public class ProcessData : BHoMObject
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/

        [Description("Inputs to the method ordered following their use in the method parameters. Inputs exclude the Source and Target of the Relation. Source and Target parameter indices are specified on the Process.")]
        public virtual List<object> Inputs { get; set; }
        ...
        public virtual List<object> Outputs { get; set; } = null;


        /***************************************************/

        //public ProcessData(IEnumerable<object> inputs, IEnumerable<object> outputs)
        //{
