...
namespace BH.oM.Lighting.Results.Illuminance
{
    ...
    public class LuxSeries : BH.oM.Lighting.Results.Mesh.MeshElementResult, IResultSeries, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public LuxSeries(IComparable objectId, IComparable nodeId, IComparable meshFaceId, IComparable resultCase, List<double> luxLevel, MeshResultSmoothingType smoothing) : base(objectId, nodeId, meshFaceId, resultCase, smoothing)
        {
            LuxLevel = luxLevel;
        }
