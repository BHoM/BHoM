...
{
    [Description("Defining reinforcement running along the element.")]
    public class PrimaryReinforcingBar : BHoMObject, IReinforcingBar
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public PrimaryReinforcingBar(ICurve centreCurve, double diameter, Material material)
        {
        ...
        public PrimaryReinforcingBar(ICurve centreCurve, double diameter, Material material, double bendRadius)
        {
            CentreCurve = centreCurve;
            Diameter = diameter;
            Material = material;
