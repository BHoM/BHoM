...
{
    [Description("A reinforcement bar with shape code 67 to BS 8666:2020 in the XY Plane centred on the midpoint of B aligned with the X axis and lowest point of C aligned with the Y axis.")]
