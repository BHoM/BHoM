...
namespace BH.oM.Physical.Reinforcement.BS8666
{
    [Description("A reinforcement bar with shape code 44 to BS 8666:2020 in the XY Plane with the free end of the A segment starting at the " +
        "Origin aligned with the X axis, the C/E parameters aligned with the X axis and the B/D parameters aligned with the Y axis.")]
    public class ShapeCode44 : BHoMObject, IShapeCode, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public ShapeCode44(double a, double b, double c, double d, double e, double diameter, double bendRadius)
        {
            A = a;
            B = b;
            C = c;
