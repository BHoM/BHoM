...
{
    [Description("A reinforcement bar with shape code 48 to BS 8666:2020 in the XY Plane centred on the Origin with the A parameter aligned with the Y axis and" +
        " the B segment aligned with the X axis.")]
    public class ShapeCode48 : BHoMObject, IShapeCode, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public ShapeCode48(double a, double b, double c, double d, double diameter, double bendRadius)
        {
            A = a;
            B = b;
            C = c;
