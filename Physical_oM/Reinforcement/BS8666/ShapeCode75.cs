...
{
    [Description("A reinforcement bar with shape code 75 to BS 8666:2020 in the XY Plane centred on the Origin. The circle starts at the lowest point of the circle (Y axis)" +
        " once laps have been accounted for.")]
    public class ShapeCode75 : BHoMObject, IShapeCode, IImmutable
    {
        ...
        public ShapeCode75(double a, double b, double diameter, double bendRadius)
        {
            A = a;
            B = b;
            Diameter = diameter;
