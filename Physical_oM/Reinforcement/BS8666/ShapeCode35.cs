...
namespace BH.oM.Physical.Reinforcement.BS8666
{
    ...
    public class ShapeCode35 : BHoMObject, IShapeCode, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public ShapeCode35(double a, double b, double c, double d, double e, double f, double diameter, double bendRadius)
        {
            A = a;
            B = b;
            C = c;
