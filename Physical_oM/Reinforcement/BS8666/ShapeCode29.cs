...
namespace BH.oM.Physical.Reinforcement.BS8666
{
    ...
    public class ShapeCode29 : BHoMObject, IShapeCode, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public ShapeCode29(double a, double b, double c, double d, double e, double diameter, double bendRadius)
        {
            A = a;
            B = b;
            C = c;
