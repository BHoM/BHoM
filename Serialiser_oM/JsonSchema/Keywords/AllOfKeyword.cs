...
{
    [Description("JSON Schema keyword that validates data against all of the provided schemas. The data must be valid against all schemas in the Options list.")]
    public class AllOfKeyword : ISchemaKeyWord
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
