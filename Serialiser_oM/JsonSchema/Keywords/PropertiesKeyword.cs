...
{
    [Description("JSON Schema keyword that defines the properties (key-value pairs) allowed in an object and their corresponding validation schemas.")]
    public class PropertiesKeyword : ISchemaKeyWord
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
