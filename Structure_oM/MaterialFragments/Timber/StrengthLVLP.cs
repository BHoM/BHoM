...
namespace BH.oM.Structure.MaterialFragments
{
    public class StrengthLVLP : IStrengthTimber
    {
        ...
        public virtual double ShearEdge { get; set; }
        ...
        public virtual double ShearFlat { get; set; }
    }
}
