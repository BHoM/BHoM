...
{
    [Description("Structural steel material to be used on structural elements and properties or as a fragment of the physical materials")]
    public class Steel : BHoMObject, IIsotropic
    {
        ...
        [Stress]
        [Description("The stress required for the material to yeild")]
        public double YieldStress { get; set; }

        [Stress]
        [Description("The stress required for the material to break")]
