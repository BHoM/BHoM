...
namespace BH.oM.Structure.MaterialFragments
{
    ...
    public class LVLC : BHoMObject, ITimber<YoungsModulusLVLC, ShearModulusLVLC, StrengthLVLC>
    {
        /***************************************************/
        ...
        public virtual YoungsModulusLVLC YoungsModulusProperties { get; set; }

        [Description("Storage for Shear Modulus proeprties in various directions.")]
        public virtual ShearModulusLVLC ShearModulusProperties { get; set; }

        [Description("Storage for Strength proeprties.")]
        public virtual StrengthLVLC Strength { get; set; }
