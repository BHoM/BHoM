...
namespace BH.oM.Structure.MaterialFragments
{
    ...
    public class Glulam : BHoMObject, ITimber<YoungsModulusGlulam, ShearModulusGlulam, StrengthGlulam>
    {
        /***************************************************/
        ...
        public virtual YoungsModulusGlulam YoungsModulusProperties { get; set; }

        [Description("Storage for Shear Modulus proeprties in various directions.")]
        public virtual ShearModulusGlulam ShearModulusProperties { get; set; }

        [Description("Storage for Strength proeprties.")]
        public virtual StrengthGlulam Strength { get; set; }
