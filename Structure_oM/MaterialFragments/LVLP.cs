...
namespace BH.oM.Structure.MaterialFragments
{
    ...
    public class LVLP : BHoMObject, ITimber<YoungsModulusLVLP, ShearModulusLVLP, StrengthLVLP>
    {
        /***************************************************/
        ...
        public virtual YoungsModulusLVLP YoungsModulusProperties { get; set; }

        [Description("Storage for Shear Modulus proeprties in various directions.")]
        public virtual ShearModulusLVLP ShearModulusProperties { get; set; }

        [Description("Storage for Strength proeprties.")]
        public virtual StrengthLVLP Strength { get; set; }
    ...
    //[Description("Structural timber material of type Laminated Veneer Lumber without crossband veneers. To be used on structural elements and properties, or as a fragment of the physical material.")]
    //public class LVLP : BHoMObject, ITimber
    //{
    //    /***************************************************/
    //    /**** Properties - General and analysis         ****/
    //    /***************************************************/
    ...
    //    public virtual double ShearModulusFlatMean { get; set; }

    //    [ShearModulus]
    //    [Description("Flatwise characteristic shear modulus parallel to the grain, G0,flat,k in Eurocode.")]
    //    public virtual double ShearModulusFlatCharacteristic { get; set; }
