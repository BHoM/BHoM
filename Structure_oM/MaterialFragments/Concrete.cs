...
namespace BH.oM.Structure.MaterialFragments
{
    ...
    public class Concrete : BHoMObject, IIsotropic
    {
        ...
        [Stress]
        [Description("Compressive stress capacity of the concrete from cylinder testing.")]
        public virtual double CylinderStrength { get; set; }

        [Stress]
        [Description("Compressive stress capacity of the concrete from cube testing.")]
        public virtual double CubeStrength { get; set; }
