...
{
    [Description("Structural concrete material to be used on structural elements and properties or as a fragment of the physical materials")]
    public class Concrete : BHoMObject, IIsotropic
    {
        ...
        [Ratio]
        [Description("Dynamic damping ratio, as ratio between actual and critical damping. Structural damping typically taken as 2% of critical, e.g. 0.02 for 2%")]
