...
namespace BH.oM.Structure.Results
{
    ...
    public abstract class TimeHistoryResult : IImmutable
    {
        ...
        [Description("Id of the Object that this result belongs to. When extracted from an analysis package, the object id will match the format and value used in that particular package.")]
        ...
        {
            TimeHistoryResult otherRes = other as TimeHistoryResult;
