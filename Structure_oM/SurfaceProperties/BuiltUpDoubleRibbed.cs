...
{
    [Description("Property for 2D analytical elements, made up of one slab supported by double parallel ribs running in one direction beneath them. Ribs and slab can all be made up of different materials.")]
    public class BuiltUpDoubleRibbed : BHoMObject, ISurfaceProperty
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        [Length]
        [Description("Height of the ribs, equal to the distance between the bottom of the slab and bottom of the ribs.")]
        public virtual double RibHeight { get; set; }

        [Length]
        [Description("Centre-centre distance between the centre of the double ribs. Measured perpendicular to the rib direction.")]
