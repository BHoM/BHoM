...
{
    [Description("0D finite element for analysis. Node class contains positional information as well as orientation.")]
    public class FlowNode : BHoMObject, IElement0D, INode, IElementM
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
