...
{
    public interface IFlowEquipment : IBHoMObject, IElement1D, IElementM, IElementF
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        [Description("The points at which the flow equipment physically connects to other MEP segments.")]
