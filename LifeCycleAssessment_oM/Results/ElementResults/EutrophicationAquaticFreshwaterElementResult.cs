...
{
    [Description("Result class for resulting Eutrophication - aquatic freshwater for a particular Element.")]
    public class EutrophicationAquaticFreshwaterElementResult : ElementResult<EutrophicationAquaticFreshwaterMaterialResult>, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public EutrophicationAquaticFreshwaterElementResult(
            IComparable objectId,
            ScopeType scope,
            ObjectCategory category,
            IReadOnlyList<EutrophicationAquaticFreshwaterMaterialResult> materialResults,
            ...
            double c1toc4,
            double d
            ) : base(objectId, scope, category, EnvironmentalMetrics.EutrophicationAquaticFreshwater, materialResults, a1, a2, a3, a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, b1tob7, c1, c2, c3, c4, c1toc4, d)
        {
        }
