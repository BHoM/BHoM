...
{
    public abstract class ElementResult2<T> : IElementResult2<T>, IImmutable
        where T : MaterialResult2
    {
        ...
        public ElementResult2(IComparable objectId, ScopeType scope, ObjectCategory category, MetricType metricType, IReadOnlyList<T> materialResults,
                        double a1,
                        double a2,
                        double a3,
                        double a1toa3,
