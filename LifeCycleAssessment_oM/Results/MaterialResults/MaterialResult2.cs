...
{
    public abstract class MaterialResult2 : IEnvironmentalResult2, IImmutable
    {
        /***************************************************/
        ...
        public MaterialResult2(string materialName, string environmentalProductDeclarationName, MetricType metricType,
                        double a1,
                        double a2,
                        double a3,
                        double a1toa3,
