...
{
    [Description("Result class for resulting Climate change - total disregarding biogenic carbon for a particular Material and EPD.")]
    public class ClimateChangeTotalNoBiogenicMaterialResult : MaterialResult, IImmutable
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        public ClimateChangeTotalNoBiogenicMaterialResult(
            string materialName,
            ...
            double c1toc4,
            double d
            ) : base(materialName, environmentalProductDeclarationName, EnvironmentalMetrics.ClimateChangeTotalNoBiogenic, a1, a2, a3, a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, b1tob7, c1, c2, c3, c4, c1toc4, d)
        {
        }
