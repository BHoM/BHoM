...
namespace BH.oM.LifeCycleAssessment.MaterialFragments
{
    ...
    public interface IEnvironmentalMetricsProvider : IBHoMObject
    {
        ...
        [Description("Note that any metric provider that does not contain this parameter will not be evaluated. \n" +
            "This metric is based on the declared unit of the reference EPD or Calculated material impact factors, i.e. a declared unit of kg refers to QuantityType of mass, a declared unit of m3 refers to a QuantityType of volume, etc. \n" +
