...
namespace BH.oM.LifeCycleAssessment.MaterialFragments
{
    public class SectorEnvironmentalProductDeclaration : BHoMObject, IEnvironmentalProductDeclarationData
    {
        ...
        [Description("Primary Energy Non-renewable Resources or PENRT is measured in megajoules.")]
        ...
        [Description("List the scope of the product application. Scopes used within the LCA_Toolkit are Structures, Foundations, Enclosures, MEP, and TenantImprovement.")]
