...
namespace BH.oM.Geometry
{
    ...
    public class NurbsSurface : ISurface, IImmutable
    {
        ...
        [Description("Allows definition of free-form external perimeter to the NurbsSurface patch. Trimmed NurbsSurfaces give greater flexibility in final form, due to the inherent requirements of a consistant UV network of Points for the underlying surface domain.")]
