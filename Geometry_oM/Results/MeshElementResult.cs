...
namespace BH.oM.Geometry.Results
{
    ...
    public abstract class MeshElementResult : IMeshElementResult, IImmutable, IObjectIdResult, ICasedResult
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        [Description("Controls how this result is sorted in relation to other results. Sorts with the following priority: Type, ObjectId, ResultCase, MeshFaceId, NodeId.")]
