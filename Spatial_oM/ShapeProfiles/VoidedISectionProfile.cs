...
namespace BH.oM.Spatial.ShapeProfiles
{
    ...
    public class VoidedISectionProfile : BHoMObject, IProfile, IImmutable
    {
        ...
        [Length]
        [Description("Height of opening through centre of the web.")]
        public virtual double OpeningHeight { get; }

        [Length]
        [Description("Height of the T section at each end of the opening.")]
        public virtual double HeightTSection { get; }
        ...
        public VoidedISectionProfile(double height, double openingHeight, double heightTSection, double width, double webthickness, double flangeThickness, double rootRadius, double toeRadius, IEnumerable<ICurve> edges)
        {
            Height = height;
            OpeningHeight = openingHeight;
            HeightTSection = heightTSection;
            Width = width;
