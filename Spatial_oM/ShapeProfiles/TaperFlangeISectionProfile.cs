...
namespace BH.oM.Spatial.ShapeProfiles
{
    ...
    public class TaperFlangeISectionProfile : BHoMObject, IProfile, IImmutable
    {
        ...
        [Length]
        [Description("Mean thickness of both flanges.")]
        public virtual double FlangeThickness { get; }

        [Angle]
        [Description("slope of the flange inner faces, generally less than 0.2 radians.")]
        ...
        [Length]
        [Description("Fillet radius at the end of the flanges. Value need to be smaller or equal than the thickness of the flange at the tip.")]
